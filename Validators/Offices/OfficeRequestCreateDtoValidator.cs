...
public class OfficeRequestCreateDtoValidator : AbstractValidator<OfficeRequestCreateDto>
{
    public OfficeRequestCreateDtoValidator(IOfficeRepository officeRepository)
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.Nit)
            ...
            .MustAsync(async (nit, cancellationToken) =>
                    !await officeRepository.IsNitUniqueAsync(nit)
            )
