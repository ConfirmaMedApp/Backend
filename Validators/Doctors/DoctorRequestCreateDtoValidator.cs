...
public class DoctorRequestCreateDtoValidator : AbstractValidator<DoctorRequestCreateDto>
{
    public DoctorRequestCreateDtoValidator(IDoctorRepository doctorRepository)
    {
        RuleFor(x => x.Name)
