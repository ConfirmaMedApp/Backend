...
public class PatientRequestUpdateDtoValidator : AbstractValidator<PatientRequestUpdateDto>
{
    public PatientRequestUpdateDtoValidator(IPatientRepository patientRepository)
    {
        RuleFor(x => x.Name)
